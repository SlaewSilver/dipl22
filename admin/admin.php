...
<body>
    ...
    $servicesNo=mysqli_num_rows(mysqli_query($link, "SELECT * FROM movieTable"));
    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                ...
                <li><div class="schedule-item schedule-item-selected"><i class="fas fa-ticket-alt"></i>Заявки <i ></i></div></li>
            ...
            <div class="admin-section-column">
                <div class="admin-section-panel admin-section-stats">
                    ...
                    <div class="admin-section-stats-panel">
                        ...
                        <h2 style="color: #4547cf"><?php echo $servicesNo ?></h2>
                        <h3>Услуг</h3>
                    </div>
                    <div class="admin-section-stats-panel">
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "                                <a href='deleteBooking.php?id=".$row['bookingID']."'><i class=\"fas fa-check accept-booking\" title=\"Reject booking\"></i></a>\n";
