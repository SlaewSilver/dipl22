...
<body>
    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                <a href="adminfeedbacks.php"><li><i class="fas fa-sliders-h"></i>Отзывы <i class="fas admin-dropdown fa-chevron-right" ></i></li></a>
                <a href="admin.php"><li><i class="fas fa-ticket-alt"></i>Заявки <i class="fas admin-dropdown fa-chevron-right"></i></li></a>
                <a href="admin.php"><li class="admin-navigation-schedule"><div class="schedule-item schedule-item-selected"><i class="fas fa-calendar-alt"></i>Франшизы </div>
                </li></a>

                <a href="adminservices.php"><li><i class="fas fa-film"></i>Услуги <i class="fas admin-dropdown fa-chevron-right"></i></li></a>
            </ul>
        </div>
                        ...
                        if($result = mysqli_query($link, $sql)){
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "                                <a href='deletefranchises.php?id=".$row['id']."'><i class=\"fas fa-check accept-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                                <a href='deletefranchises.php?id=".$row['id']."'><i class=\"fas fa-times decline-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                            </div>\n";
                                    ...
                                    echo "                                </div>\n";
                                    echo "                                <div>\n";
                                    echo "                                    <h4>". $row['country'] ." ". $row['phone'] ."</h4>\n";
                                    echo "                                    <i class=\"fas fa-circle\"></i>\n";
                                ...
                                echo '<h4 class="no-annot">No Franchises right now</h4>';
                            }
                        } else{
