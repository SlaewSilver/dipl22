...
<div mt="150px" class="container">
    <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
            <h1><center>Пожалуйста , заполните форму для приобретения франшизы !</center></h1><br>
            ...
            <form action="" method="POST" >
                <div class="box-body">
                    ...
                    <div class="step_1">
                        ...
                        <div class="form-group">
                            <label for="subject">Позиция:-</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control country" name="country" id="country"  >
                                <?php
                                $arr = array("Киев","Днепр","Харьков","Львов","Одесса","Чернигов", "Другой город");
                ...
                if(isset($_POST['submit'])){
                    ...
                    echo "<script>alert(\"После рассмотрения заявки менеджер свяжется с вами\");</script>";
                }
